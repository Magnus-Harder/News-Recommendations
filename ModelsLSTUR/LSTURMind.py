...
class UserEncoder(nn.Module):
    ...
    def forward(self, user_id, history_title):
        ...
        output,hidden = self.gru(news_embed, user_embed.unsqueeze(0))
...
class LSTURini(nn.Module):
    ...
    def forward(self, user_id, history_title, impressions_title):
        
        # User embedding
        Users = self.UserEncoder(user_id, history_title)
