...
filestring = f'EvaluationTranformerOwn{hparams["model"]["Transformer"]["model"]}{hparams["model"]["Transformer"]["set"]}.pkl'
...
Dictfilestring = f'TransformerOwn{hparams["model"]["Transformer"]["model"]}{dataset}Predictions.pkl'
